...
averaged_signif = wave_signif(stage_final, dt, scale, ...
                            1, alpha,-1, n_sample);

%% plots
myplotwavelet(t, stage_final, scale, coi, period, power, ...
